...
perm_dic = {
    'normal': ['customer_list', 'GET', []],  # 权限字段名称(models表中定义)，URL别名,GET方法,请求参数
    'moderator': ['customer_detail', 'GET', []],
    'admin': ['customer_detail', 'GET', []],
    'superadmin': ['customer_detail', 'POST', ['qq', 'name']],  # GET为查询，POST提交数据
}
...
def check_permission(func):
    def wrapper(*args, **kwargs):
        ...
        if not perm_check(*args, **kwargs):
            return render(args[0], 'error_page/403.html')
